...
class MbbEngine:
    ...
    def cover_centered(self, title, subtitle='', author='', date='', cover_image=None):
        ...
        # ── Text layout: shift left when image is present ───
        if img_path:
    ...
    def big_number(self, title, number, unit='', description='',
        ...
        if detail_items:
            ...
            add_text(s, LM + Inches(0.3), Inches(4.6), Inches(1.8), Inches(0.4),
                     'Solution' if not unit else 'Detail',
    ...
    def table_insight(self, title, headers, rows, insights,
        ...
        Right ~32%: "Insight:" title + decorative line + bullet insights.
        ...
        insight_title : str — title for the right panel (default 'Insight:').
        """
        import re
        s = self._ns()
        add_action_title(s, title)
        ...
        if n_insights > 0:
            ...
            # "Insight:" title (no decorative line above)
    ...
    def before_after(self, title, before_title, before_points,
        ...
        corner_label : str
            Optional dashed corner label (e.g. 'Part II > Decline').
    ...
    def kpi_tracker(self, title, kpis, summary=None, source=''):
        ...
        # Headers
        hy = Inches(1.3)
        add_text(s, LM, hy, Inches(3.5), Inches(0.35), 'KPI',
    ...
    def risk_matrix(self, title, grid_colors, grid_lights, risks,
        ...
        if notes:
            ...
            add_text(s, LM + Inches(0.3), Inches(5.15), Inches(1.5), Inches(0.3),
                     'Response', font_size=BODY_SIZE, font_color=NAVY, bold=True)
    ...
    def multi_bar_panel(self, title, panels, connectors=None, footnotes=None, source=''):
        ...
        panels : list[dict]
            Each panel dict has:
              ...
              - 'unit': str — Y-axis unit label, e.g. 'M people'
              - 'legend': str — legend text, e.g. 'Population aged 15-64'
